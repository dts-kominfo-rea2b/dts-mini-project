...
const MovieView = () => {
        ...
        const getMoviesView = async () => {
                try {
                        ...
                        setMoviesView(fetchedMovies.data);
                } catch (error) {
                        console.log(error);
                }
        }
        ...
        return (
                <div className="flex flex-col w-full h-auto gap-y-8">
                        <div className="relative flex w-full bg-slate-200">
                        <img
                        src={`${BASE_IMAGE_URL}${moviesView.backdrop_path}`}
                        alt=""
                        ...
                        <div className="w-full h-auto px-11" align="left">
                        <p className="mt-3 mb-1">Description :</p>
                        <p>{moviesView.overview}</p>
                        </div>
                </div>
        );
};
