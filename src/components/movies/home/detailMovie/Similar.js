        ...
        <Carousel
          ...
          arrowLeft={
            <div className="absolute flex flex-col items-center px-1 justify-center z-[104] cursor-pointer h-full left-8 rounded-l-sm bg-slate-800 bg-opacity-80">
              <svg className="rotate-180" width="20" height="34" viewBox="0 0 20 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.41423 0L0.641113 1.76728L15.8243 17L0.641113 32.2327L2.41423 34L19.3589 17L2.41423 0Z" fill="white" />
              </svg>
            </div>
          }
          arrowRight={
        ...
        >
          ...
          {dataFeedback.slice(0, 30).map((data) => (
            <Carousel.Item key={data.id}>
              <Link to={`/dts-movies/home/detail/${data.id}`} onMouseEnter={() => setSelected(data.id)} onMouseLeave={() => setSelected(null)}>
                <div className="relative cursor-pointer">
                  {selected === data.id && (
                    <div className={selected === data.id ? 'absolute z-[102] flex w-full h-full bg-black opacity-50' : ''}>
                      <div className="flex w-full h-full justify-center items-center">
                        <p className="inline-flex w-auto justify-center h-auto px-4 py-1 border-2 border-white gap-x-3 items-center">
                          <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0.333328L20 11L0 21.6667V0.333328Z" fill="white" />
                          </svg>
                  ...
                  <div className="absolute z-[101] top-0 right-0">
                    {data.popularity > 10000 && (
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 2C0 0.89543 0.895431 0 2 0H22C23.1046 0 24 0.895431 24 2V22C24 23.1046 23.1046 24 22 24H2C0.89543 24 0 23.1046 0 22V2Z" fill="#B9090B" />
                        <path d="M6.8137 9.392H5.5097V4.95201H3.7417V3.82401H8.5817V4.95201H6.8137V9.392Z" fill="white" />
                        <path
                        ...
                        <path
                          ...
                          fill="white"
                        />
                        <path d="M7.93716 20.392V12.566L5.61316 13.28V11.642L9.78516 10.466V20.392H7.93716Z" fill="white" />
                        <path
                  ...
                  <img
                    ...
                    alt=""
                    className={selected === data.id ? 'w-[285px] h-auto scale-95 aspect-2/3 object-cover transition-all duration-100' : 'w-[285px] h-auto aspect-2/3 transition-all duration-100'}
                  />
                </div>
              </Link>
            </Carousel.Item>
