...
import { Alert, AlertTitle, Box, Button, TableFooter, Typography } from '@mui/material';
...
const Pricing = () =>{
    ...
    const subscribed = (plan) =>{
        //logic untuk melakukan subcribe
        //misal ada popup pembayaran
                ...
                <Table aria-label="simple table">
                    ...
                    <TableFooter>
                        <TableRow>
                            <TableCell></TableCell>
                            <TableCell align="center">
                                <Button variant="contained" onClick={()=>subscribed("bronze")}>Buy now</Button>
                            </TableCell>
                            <TableCell align="center">
                                <Button variant="contained" onClick={()=>subscribed("gold")}>Buy now</Button>
                            </TableCell>
                            <TableCell align="center">
                                <Button variant="contained" onClick={()=>subscribed("platinum")}>Buy now</Button>
                            </TableCell>
                        </TableRow>
                    </TableFooter>
                </Table>
